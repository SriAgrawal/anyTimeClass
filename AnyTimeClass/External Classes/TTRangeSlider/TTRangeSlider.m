...
- (void)initialiseControl {
    ...
    _handleDiameter = 30.0;
    _selectedHandleDiameterMultiplier = 1.1;
    
    _lineHeight = 2.0;
    
    _handleBorderWidth = 1.0;
    ...
    self.sliderLineBetweenHandles.backgroundColor = [UIColor redColor].CGColor;
    ...
    self.leftHandle.borderColor = [UIColor colorWithRed:227.0/255.0f green:227.0/255.0f blue:227.0/255.0f alpha:0.9f].CGColor;
    ...
    self.rightHandle.borderColor = [UIColor colorWithRed:227.0/255.0f green:227.0/255.0f blue:227.0/255.0f alpha:0.9f].CGColor;
    ...
    self.minLabel.contentsScale = [UIScreen mainScreen].scale;
    self.minLabel.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"pop"]].CGColor;
    ...
    self.maxLabel.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"pop"]].CGColor;
...
- (void)updateLabelPositions {
    ...
    self.minLabel.frame = CGRectMake(0, 0, 52, 32);
    self.maxLabel.frame = CGRectMake(0, 0, 52, 32);
