...
#import "SSKeyboardAvoidingScrollView.h"

@interface SSKeyboardAvoidingScrollView () <UITextFieldDelegate, UITextViewDelegate>
@end

@implementation SSKeyboardAvoidingScrollView
